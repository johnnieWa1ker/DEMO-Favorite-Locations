...
class DetailPlacePresenter: ViperPresenter, DetailPlacePresenterInput, DetailPlaceViewOutput {
    ...
    func pressedSaveButton() {
        ...
        case .create:
            ...
            // TODO: Рейтинг захардкожен
            let place = PlaceManager.newPlace(title: viewModel.newPlaceTitle ?? "",
                                              description: viewModel.newPlaceDescription,
                                              type: viewModel.newPlaceType,
                                              rating: 3.0)
