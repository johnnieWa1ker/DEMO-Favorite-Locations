...
enum DetailPlaceAssembly {
    ...
    static func configure(with reference: DetailPlaceViewController, place: PlaceModel?, crudType: CrudType, input: ViperPresenterInput) -> DetailPlacePresenterInput {
        let presenter = DetailPlacePresenter(place: place, crudType: crudType, input: input)
